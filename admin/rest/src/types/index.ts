...
export interface FlashSaleImagePaginator {
  result: FlashSaleImage[];
  total: number;
  currentPage: number;
  perPage: number;
}
...
export interface Shop {
  result?: [
    {
      ...
      productCount?: number;
      address?: UserAddress;
      settingDto?: ShopSettings;
      settings?: ShopSettings;
      shopAddressDto?: UserAddress;
      created_at?: string;
      updated_at?: string;
      isActive?: boolean;
    },
  ...
  ordersCount?: number;
  productCount?: number;
  balance?: Balance; // Ensure balance is accessible at the top level
  balanceDto?: any;
  name?: string;
  slug?: string;
  description?: string;
