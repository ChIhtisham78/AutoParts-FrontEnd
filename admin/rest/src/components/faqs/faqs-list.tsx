...
const FaqsLists = ({
  ...
  const columns = [
    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            ...
            sortingObj?.column === 'faqTitle'
          }
          isActive={sortingObj?.column === 'faqTitle'}
        />
      ),
      className: 'cursor-pointer',
      dataIndex: 'faqTitle',
      ...
      ellipsis: true,
      width: 200,
      onHeaderCell: () => onHeaderClick('faqTitle'),
      render: (text: string) => (
    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj?.sort === SortOrder?.Asc &&
            sortingObj?.column === 'faqDescription'
          }
          isActive={sortingObj?.column === 'faqDescription'}
        />
      ),
      className: 'cursor-pointer',
      ...
      width: 300,
      ellipsis: true,
      onHeaderCell: () => onHeaderClick('faqDescription'),
      render: (text: string) => (
        <span
...

    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj?.sort === SortOrder?.Asc &&
            sortingObj?.column === 'faqType'
          }
          isActive={sortingObj?.column === 'faqType'}
        />
      ),
      className: 'cursor-pointer',
      dataIndex: 'faqType',
      ...
      align: 'center',
      width: 100,
      onHeaderCell: () => onHeaderClick('faqType'),
      render: (text: string) => (
        <span className="whitespace-nowrap">{text}</span>
      ),
    },

    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj?.sort === SortOrder?.Asc &&
            sortingObj?.column === 'issuedBy'
          }
          isActive={sortingObj?.column === 'issuedBy'}
        />
      ),
      className: 'cursor-pointer',
      dataIndex: 'issuedBy',
      ...
      align: 'center',
      width: 100,
      onHeaderCell: () => onHeaderClick('issuedBy'),
      render: (text: string) => (
        <span className="whitespace-nowrap">{text}</span>
      ),
    },
