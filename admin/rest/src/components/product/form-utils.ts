...
export function getProductDefaultValues(
  ...
  return cloneDeep({
    ...
    categories: { ...product.categoryDto },
    manufacturer: { ...product.manufacturersDto },
    tags: product.tagDto,
    subcategory: { ...product.subCategoryListDto },
    model: [{ ...product.manufactureModelDto }],
    engine: [{ ...product.engineDto }],

    image: {
      id: product.imageDto?.id || 0,
      original: product.imageDto?.originalUrl,
      thumbnail: product.imageDto?.thumbnailUrl,
      message: product.imageDto?.originalUrl,
    },
    gallery: [
      {
        id: product.productGalleryImageDto?.id,
        original: product.productGalleryImageDto?.originalUrl,
        thumbnail: product.productGalleryImageDto?.originalUrl,
        message: product.productGalleryImageDto?.originalUrl,
      },
    ],
