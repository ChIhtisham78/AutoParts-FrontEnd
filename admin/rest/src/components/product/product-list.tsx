...
const ProductList = ({
  ...
  let columns = [
...

    {
      title: (
        <TitleWithSort
          ...
          ascending={
            ...
            sortingObj.column === 'subPrice'
          }
          isActive={sortingObj.column === 'subPrice'}
        />
      ),
      className: 'cursor-pointer',
      dataIndex: 'subPrice',
      ...
      align: alignRight,
      width: 180,
      onHeaderCell: () => onHeaderClick('subPrice'),
    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj.sort === SortOrder.Asc &&
            sortingObj.column === 'shippingCharges'
          }
          isActive={sortingObj.column === 'shippingCharges'}
        />
      ),
      className: 'cursor-pointer',
      ...
      align: alignRight,
      width: 180,
      onHeaderCell: () => onHeaderClick('shippingCharges'),
      render: function Render(value: number, record: Product) {
        const { price: max_price } = usePrice({
          amount: record?.max_price as number,
        });
