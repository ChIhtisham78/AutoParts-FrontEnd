...
export default function CreateOrUpdateTaxForm({ initialValues }: IProps) {
  ...
  const { mutate: createTaxClass, isLoading: creating } = useCreateTaxClassMutation();
  const { mutate: updateTaxClass, isLoading: updating } = useUpdateTaxClassMutation();
