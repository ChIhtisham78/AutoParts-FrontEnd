...
export default function CreateFlashSaleImagePage() {
  ...
  return (
    <>
      ...
      <CreateOrUpdateFlashSaleImageForm />
    </>
  );
}
CreateFlashSaleImagePage.authenticate = {
  permissions: adminOnly,
};
CreateFlashSaleImagePage.Layout = Layout;
