...
export const siteSettings = {
  ...
  author: {
    name: 'EasyParts',
    websiteUrl: 'https://easypartshub.com',
    address: '',
  },
  headerLinks: [],
  authorizedLinks: [
    ...
    admin: {
      ...
      product: {
        ...
        childMenu: [
          ...
          {
            href: Routes.model.list,
            label: 'Models',
            icon: 'ManufacturersIcon',
          },
          {
            href: Routes.engine.list,
            label: 'Engines',
            icon: 'CategoriesIcon',
          },
          {
        ...
        childMenu: [
          {
            ...
            //     },
            //     {
            //         href: "/recallInformation",
            //         label: 'Recall Information',
            //     },
            //     {
            //         href: "/sameDayDelivery",
      ...
      promotional: {
        ...
        childMenu: [
          ...
          {
            href: Routes.flashSaleImage.list,
    ...
    shop: {
      ...
      product: {
        ...
        childMenu: [
          ...
          {
            href: (shop: string) => `/${shop}${Routes.model.list}`,
            label: 'Models',
            icon: 'ManufacturersIcon',
            permissions: adminAndOwnerOnly,
          },
          {
            href: (shop: string) => `/${shop}${Routes.engine.list}`,
            label: 'Engines',
            icon: 'CategoriesIcon',
            permissions: adminAndOwnerOnly,
          },
          {
            href: (shop: string) => `/${shop}/shipping-price`,
