...
export const useProductQuery = ({ slug, language }: GetParams) => {
  const { data, error, isLoading } = useQuery<Product, Error>(
    ['api/product/product', { slug, language }],
...
export const useProductsShopQuery = (
  params: Partial<ProductQueryOptions>,
  options: any = {},
) => {
  const { data, error, isLoading } = useQuery<Product, Error>(
    [`/api/product/product-by-shopId/${params.shop_id}`, params],
    () => productClient.getProductByShop({ shop_id: params.shop_id }),
    {
