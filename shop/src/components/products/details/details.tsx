...
const Details: React.FC<Props> = ({
  ...
  const details = [
    ...
    { label: 'VIN Number', value: product.vin },
    ...
    { label: 'Mileage', value: product.mileage },
    { label: 'Grade', value: product.grade },
    { label: 'Condition', value: product.newUsed === 'used' ? 'Used' : 'New' }, // Assuming 'newUsed' indicates condition
    {
      label: 'Model',
      value: product.model,
    },
    ...
    { label: 'OEM Part Number', value: product.oemPartNumber },
    { label: 'Partslink Number', value: product.partslinkNumber },
  ];
  ...
  const previewImages = displayImage(
        ...
        <div className="flex flex-col items-start p-5 pt-10 md:w-1/2 lg:p-14 xl:p-16">
          ...
          {shopDto?.name && (
            <div className="mt-2 flex items-center">
              ...
              <button
                onClick={() => navigate(Routes.shop(shopDto?.slug))}
